		        ...
		        <div class="row cg-lotto-info card z-depth-2">
		        	<div class="lotto-left col s4">
			            ...
			            <div class="cg-dates text-center clearfix">
			                ...
			                <h6>Game Start:</h6>{{ gameStartTime | moment("MMM Do YYYY hh:mm A") }} <h6>Game End:</h6>{{ gameEndTime | moment("MMM Do YYYY hh:mm A")}}
			        ...
			        <div class="lotto-right col s8">
			            ...
			            <div v-else class="cg-jackpot text-center"><h3>Current Jackpot</h3>{{ potSize }} <span class="currency">{{ getNetworkType === "Testnet" ? 'tWGR' : 'WGR' }}</span></div>
			            ...
			            <div class="all-stats">
			                ...
			                <div class="col s4 text-center stats">
			                    ...
			                    <div v-else class="cg-info">{{ getCGWinnings(potSize, 'bet') }} <span class="currency">{{ getNetworkType === "Testnet" ? 'tWGR' : 'WGR' }}</span></div>
			                ...
			                <div class="col s4 text-center  stats">
			                    ...
			                    <div v-else class="cg-info">{{ getCGWinnings(potSize, 'masternode') }} <span class="currency">{{ getNetworkType === "Testnet" ? 'tWGR' : 'WGR' }}</span></div>
			                ...
			                <div class="col s4 text-center stats">
			                    ...
			                    <div v-else class="cg-info">{{ getCGWinnings(potSize, 'burn') }} <span class="currency">{{ getNetworkType === "Testnet" ? 'tWGR' : 'WGR' }}</span></div>
