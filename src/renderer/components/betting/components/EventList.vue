            ...
            <ul class="events-list">
                ...
                <li v-for="( event ) in eventsList" :key="event.event_id" class="card">
                    ...
                    <div class="event-tournament">
                        ...
                        <span class="date pull-right">{{ Number(event.starting) | moment('timezone', getTimezone, 'LLL') }}</span>
                    ...
                    <div class="event-pair row">
                        ...
                        <div class="col s12 m4 event-teams">
                            ...
                            <div class="teams"><div class="team-name">{{ event.teams.home }}</div></div>

                            <div class="teams"><div class="team-name">{{ event.teams.away }}</div></div>

                            <div class="teams"><div class="team-name">Draw</div></div>
