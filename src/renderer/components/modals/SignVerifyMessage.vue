                ...
                <div id="sign-message-form" class="sign-message">
                    ...
                    <form @submit.prevent="handleSignSubmit()" data-vv-scope="sign-form">
                        ...
                        <div class="input-field col s12">
                            ...
                            <span v-if="errors.has('sign-form.sign-address')" class="form-error">{{ errors.first('sign-form.sign-address') }}</span>
                        ...
                        <div class="input-field col s12">
                            ...
                            <span v-if="errors.has('sign-form.sign-message')" class="form-error">{{ errors.first('sign-form.sign-message') }}</span>
                        ...
                        <div class="col s1">
                            ...
                            <a class="btn waves-effect waves-light sign-message__copy wagerr-red-bg" @click="copiedAlert()" v-clipboard="signedSignature">
                ...
                <div id="verify-message-form" class="verify-message">
                    ...
                    <form @submit.prevent="handleVerifySubmit" data-vv-scope="verify-form">
                        ...
                        <div class="input-field col s12">
                            ...
                            <span v-if="errors.has('verify-form.verify-address')" class="form-error">{{ errors.first('verify-form.verify-address') }}</span>
                        ...
                        <div class="input-field col s12">
                            ...
                            <span v-if="errors.has('verify-form.verify-message')" class="form-error">{{ errors.first('verify-form.verify-message') }}</span>
                        ...
                        <div class="input-field col s12">
                            ...
                            <span v-if="errors.has('verify-form.verified-signature')" class="form-error">{{ errors.first('verify-form.verified-signature') }}</span>
