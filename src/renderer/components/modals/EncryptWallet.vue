            ...
            <div class="modal-content">
                ...
                <div class="row">
                    ...
                    <div class="modal-text">
                        ...
                        <p class="modal-font">Enter the new password which will be used to unlock your wallet.</p>

                        <p>Please use a secure password of seven or more random characters.</p>
                    ...
                    <div class="input-field col s12">
                        ...
                        <span v-if="errors.has('confirm-password')" class="form-error">{{ errors.first('confirm-password') }}</span>
