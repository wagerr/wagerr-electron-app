            ...
            <div class="modal-content">
                ...
                <div class="row">
                    ...
                    <div class="modal-text">
                        ...
                        <p class="modal-font">Enter the old and new password to update the password used to unlock the wallet.</p>
                    ...
                    <div class="input-field col s12">
                        ...
                        <span v-if="errors.has('old-password')" class="form-error">{{ errors.first('old-password') }}</span>
                    ...
                    <div class="input-field col s12">
                        ...
                        <span v-if="errors.has('new-password')" class="form-error">{{ errors.first('new-password') }}</span>
                    ...
                    <div class="input-field col s12">
                        ...
                        <span v-if="errors.has('conf-password')" class="form-error">{{ errors.first('conf-password') }}</span>
        ...
        methods: {
            ...
            changePassword: function () {
                ...
                wagerrRPC.client.walletPassphraseChange(this.oldPassword, this.newPassword)
                    .then(function (resp) {
                        M.toast({ html: '<span class="toast__bold-font">Success &nbsp;</span> Wallet password has been updated.' , classes: 'green' });
